...
"""
This is a benchmark of the TensorFlow code for TFSingleOrigin using different matrix sizes.
...
"""
def benchmarkTFSingleOriginMatrixSizes(Nstart,Nfinish):
